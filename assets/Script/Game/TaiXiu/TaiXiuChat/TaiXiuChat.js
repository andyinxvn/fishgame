...
cc.Class({
	...
	message: function(data, tobot = false){
		...
		if(data.top > 0 && data.top < 6){
			itemComponent.string = "(TOP "+data.top+") "+data.user + ': ' + data.value;
		...
		if(data.top > 0 && data.top < 6){
			name.string = "(TOP "+data.top+") "+data.user;

			if(data.top == 1){
				name.node.color  = new cc.Color(0,156,255);
			}else if(data.top == 2){
				name.node.color  = new cc.Color(0,255,84);
			}else if(data.top == 3){
				name.node.color  = new cc.Color(255,144,0);
			}else if(data.top == 4){
				name.node.color  = new cc.Color(241,40,0);
			}else if(data.top == 5){
				name.node.color  = new cc.Color(241,0,91);
			}
		}else{

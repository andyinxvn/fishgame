...
cc.Class({
	...
	onClickNap: function(){
		...
		}else if (helper.getOnlyNumberInString(this.inputTien.string)>>0 < 20000) {
			cc.RedT.inGame.notice.show({title:"NẠP RED", text: "Nạp tối thiểu 20.000, tối đa 1.000.000.000"});
